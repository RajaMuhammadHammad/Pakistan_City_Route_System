...
{ 
    public partial class Form5 : Form
    {
        ...
        private void InitializePakistanMap()
        {
            ...
            M.MapProvider = GMap.NET.MapProviders.GoogleMapProvider.Instance;
            M.Zoom = 7;

            // Initialize the overlay for the route
            routeOverlay = new GMapOverlay("routeOverlay");
            M.Overlays.Add(routeOverlay);
            M.MinZoom = 5;
            M.MaxZoom = 100000;
            M.Zoom = 10;
            M.DragButton = MouseButtons.Left;

            cityOverlay = new GMapOverlay("cityOverlay"); // Initialize the overlay for city markers
            M.Overlays.Add(cityOverlay); // Add city overlay to the map
        ...
        private void InitializeFinalPathListCords()
        {
            ...
            foreach (int i in Algoritm2.path)
            {
        ...
        private void DrawRoute()
        {
            ...
            M.ZoomAndCenterRoutes("routeOverlay");
        }
